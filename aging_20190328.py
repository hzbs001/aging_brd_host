...
class App(tk.Frame):
    ...
    def createWidgets(self):
        ...
        self.addrLabel = tk.Label(self,fg='#00f',bg='#0f0',width=64,font=helv16,\
                text='100 CH Datas Monitor System')
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_ad,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_1,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_9,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_17,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_25,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_2,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_10,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_18,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_26,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_3,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_11,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_19,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_27,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_4,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_12,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_20,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_28,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_5,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_13,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_21,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_29,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_6,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_14,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_22,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_30,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_7,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_15,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_23,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_31,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_8,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_16,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_24,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_32,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_rl,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_fs,bg='white',fg='red',width=8,font=helv24)
        ...
        self.addrEntry = tk.Entry(self,textvariable=val_ser,bg='white',fg='red',width=24,font=helv24)
        self.addrEntry.grid(row=16,column=40,columnspan=24)


app1 = App()
app1.master.title('MBDisp_20190330')
app1.mainloop()
