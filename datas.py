...
for i in range(0,100):
    rsens.append(0)
def sampleDatas(ser1,chk_en,val_1,val_2,val_3,val_4,val_5,val_6,val_7,val_8,\
    ...
    if count>data_len:
        for i in range(1,data_len+1):
            ...
            rsens[i-1] = (FS/(ttt+0.01)-1)*RL/1e3
            if rsens[i-1]>999999:
                rsens[i-1] = 999999
        ...
        for i in range(1,data_len2+1):
            ...
            rsens.append((FS/(ttt2+0.01)-1)*RL/1e3)
        ############Second read End##################
